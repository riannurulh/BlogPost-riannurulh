...
const Form = (props) => {
    const {handlePost,title,content,imgUrl,categoryId,setTitle,setContent,setImgUrl,setCategoryId,setCategoryList,categoryList} = props
  return (
    <form 
    onSubmit={handlePost}
    >
      <div className="mb-8">
        <h3 className="text-gray-800 text-3xl font-extrabold">{title?"Edit Post":"Create New Post"}</h3>
      </div>
